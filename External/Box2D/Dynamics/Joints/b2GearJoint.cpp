...
void b2GearJoint::InitVelocityConstraints(const b2SolverData& data)
{
	...
	else
	{
		...
		m_mass += m_ratio * m_ratio * (m_FT + m_mB) + m_iD * m_JwD * m_JwD + m_iB * m_JwB * m_JwB;
	}
...
bool b2GearJoint::SolvePositionConstraints(const b2SolverData& data)
{
	...
	else
	{
		...
		mass += m_ratio * m_ratio * (m_FT + m_mB) + m_iD * JwD * JwD + m_iB * JwB * JwB;
