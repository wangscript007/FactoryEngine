...
public:
    ...
    Vec2        Bezier(const Vec2& b, const Vec2& c, const Vec2& vD, float fT) const;
...
inline Vec2 Vec2::Bezier(const Vec2& b, const Vec2& c, const Vec2& vD, float fT) const
{
    return Vec2(Util::Bezier(mX, b.mX, c.mX, vD.mX, fT), Util::Bezier(mY, b.mY, c.mY, vD.mY, fT));
}
